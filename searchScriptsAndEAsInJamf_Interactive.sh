...
echo -e "What do you want to search?"
echo -e "1. Scripts only"
echo -e "2. Extension Attributes only"
echo -e "3. Both"
...
if [ "$countScripts" -gt 0 ] && [ "$countEAs" -gt 0 ]; then
    echo "Search is finished, happy $countScriptsFoundName and $countEAsFoundName reviewing"
